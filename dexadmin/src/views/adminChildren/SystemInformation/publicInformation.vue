  ...
  <div class="">
    <el-card class="box-card components-container">
      ...
      <div class="text item">
        ...
        <div>
          <tinymce v-model="content" :height="530" />
        </div>
      </div>
    </el-card>
...
export default {
  ...
  methods:{
    async publicInfo(){
      ...
      this.information.content=this.content;
      const res=await this.axios.post('DexAdmin/adminPublicInformation',this.$qs.stringify(
          this.information
      ))
